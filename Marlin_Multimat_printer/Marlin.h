...
extern uint8_t factor_rendimiento_extrusion ;
...
#endif
void abre_obturador();
void cierra_obturador();

#if ENABLED(UVPRINT)||ENABLED(PASTAPRINT) 
  extern float sangrado_mm3_min; //Se modifica con gcode M13 para la sesion. (rpm para el sangrado manual)
#endif
#endif // MARLIN_H
